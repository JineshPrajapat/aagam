...
export const Hero: FC<{}> = ({}) => {
  ...
  return (
    ...
    <div className="flex justify-center items-center w-full h-screen bg-[url('/wp2974616.jpg')] animate-gradient ">
      <div className="w-im h-im rounded-full shadow-sh relative ">
        <div className="absolute">
          <Image src="/AAGAMLOGO1.png"
                  width={470}
                  height={470}
                  alt="Logo"
